...
void AppCore::refreshOperationalView()
{
  ...
  switch (ui_.route)
  {
    ...
    case UiRoute::DiagnosticsPage:
      ...
      view_.main.info.rows[4].label = "LAN IP";
      view_.main.info.rows[4].value = textOrDash(ui_.diagnostics.wifiLocalIp);
      view_.main.info.rows[5].label = "Last Sync";
      view_.main.info.rows[5].value = formatEpochCompact(ui_.diagnostics.lastWeatherSyncEpoch);
      view_.main.info.rows[6].label = "Refresh";
      view_.main.info.rows[6].value = formatUint32(ui_.diagnostics.refreshIntervalMinutes) + "m";
      view_.main.info.rows[7].label = "RAM Total";
      view_.main.info.rows[7].value = formatUint32(ui_.diagnostics.ramTotalBytes);
      view_.main.info.rows[8].label = "Free Heap";
      view_.main.info.rows[8].value = formatUint32(ui_.diagnostics.freeHeapBytes);
      view_.main.info.rows[9].label = "Max Block";
      view_.main.info.rows[9].value = formatUint32(ui_.diagnostics.maxFreeBlockBytes);
      view_.main.info.rows[10].label = "Heap Frag";
      view_.main.info.rows[10].value = formatUint32(ui_.diagnostics.heapFragmentationPercent) + "%";
      view_.main.info.rows[11].label = "Flash Used";
      view_.main.info.rows[11].value = formatUint32(ui_.diagnostics.programFlashUsedBytes);
      view_.main.info.rows[12].label = "Flash Total";
      view_.main.info.rows[12].value = formatUint32(ui_.diagnostics.programFlashTotalBytes);
