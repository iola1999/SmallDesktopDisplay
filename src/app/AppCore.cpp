...
void AppCore::refreshOperationalView()
{
  ...
  switch (ui_.route)
  {
    ...
    case UiRoute::DiagnosticsPage:
      ...
      view_.main.info.rows[7].label = "Free Heap";
      view_.main.info.rows[7].value = formatUint32(ui_.diagnostics.freeHeapBytes);
      view_.main.info.rows[8].label = "Flash Used";
      view_.main.info.rows[8].value = formatUint32(ui_.diagnostics.programFlashUsedBytes);
      view_.main.info.rows[9].label = "Flash Total";
      view_.main.info.rows[9].value = formatUint32(ui_.diagnostics.programFlashTotalBytes);
